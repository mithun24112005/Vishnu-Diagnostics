  ...
  return (
    <section className="section-padding">
      <div className="content-container">
        ...
        <StaggerChildren className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {BOOKING_SERVICES.map((service) => (
            <StaggerItem key={service.title}>
              <div className="bg-surface border border-hairline rounded-lg p-6 flex flex-col h-full">
                ...
                <BookButton label="Book Now" className="w-full justify-center mt-auto" />
              </div>
            </StaggerItem>
          ))}
        </StaggerChildren>
